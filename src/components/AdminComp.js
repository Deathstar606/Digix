...
import { Container, Form, FormGroup, Label, Input, Button, Progress, Row, Col, Card, CardBody, CardTitle, CardText } from "reactstrap";
...
const CaseStudyForm = ({uploadToCloudinary, uploadToGoogleDrive, accessToken}) => {
...
function PeopleCard({ people, updatePople, deletePeople }) {
  ...
  const handleShow = (item) => {
    ...
    setFormData({ name: item.name, designation: item.designation ,description: item.description });
    setShowForm(true);
  }
  ...
  const handleSubmit = async (e, _id) => {
    e.preventDefault();
    await updatePople(_id, formData.name, formData.designation, formData.description);
    setShowForm(false);
  };

  return (
      <div className="d-flex flex-wrap justify-content-center gap-4 p-3" style={{position: "relative"}}>
        {people.map((person, index) => (
          <>
            <Card key={index} style={{ width: "18rem", marginBottom: "15px" }} className="shadow-sm">
              <img
                src={person.image}
                alt={person.name}
              ...
              <CardBody>
                ...
                <CardText style={{paddingBottom: "30px"}}>{person.description}</CardText>
                <div className="d-flex justify-content-between" style={{position: "absolute", bottom: "15px", right: "15px"}}>
                  <Button onClick={() => handleShow(person)} className="mr-2" color="primary">Update</Button>
                  <Button onClick={() => handleDelete(person._id)} color="danger">Delete</Button>
                </div>
              </CardBody>
            </Card>
            <AnimatePresence>
                  ...
                  >
                    <Container>
                      <Row className="justify-content-center ml-1 mr-1">
                        <Col md={5} className="p-4" style={{ backgroundColor: "white", border: "black solid 2px", position: "relative"}}>
                          <h2 className="text-center mb-4">Add People</h2>
                              ...
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  value={formData.name}
                                  onChange={handleChange}
                                  style={{ border: "2px solid black", backgroundColor: "transparent" }}
                                  className="rounded-0"
                              ...
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  onChange={handleChange}
                                  style={{ border: "2px solid black", backgroundColor: "transparent", height: "150px" }}
                                  className="rounded-0"
          ...
          <>
            <Card key={index} style={{ width: "18rem" }} className="shadow-sm">
              ...
              <CardBody>
                ...
                <CardText style={{paddingBottom: "30px"}}>{item.description}</CardText>
                <div className="d-flex justify-content-between" style={{position: "absolute", bottom: "15px", right: "15px"}}>
                  <Button onClick={() => handleShow(item)} className="mr-2" color="primary">Update</Button>
                  <Button onClick={() => handleDelete(item._id)} color="danger">Delete</Button>
                </div>
              </CardBody>
            </Card>
            <AnimatePresence>
...
const AdminComp = (props) => {
    ...
    const CLIENT_ID = '631732047886-96fl23jud9deq0e40f7ndo54rpguf5th.apps.googleusercontent.com';
  ...
  return (
    !props.auth.isAuthenticated ? (
      <Container style={{height: "100vh"}} className="p-4 d-flex align-items-center justify-content-center">
        <Col md={6} xs={12}>
          <Form onSubmit={handleSubmitAdmin} className="p-4 border-0 shadow">
            <h2 className="mb-4 text-center" style={{color: "rgb(255, 94, 0)"}}>Admin Login</h2>
            <FormGroup>
      ...
      <>
        <Container>
          <Row>
            <Col md={6} xs={6}>
              <h1 style={{marginTop: "100px", color: "rgb(255, 94, 0)", fontSize: "clamp(1.5rem, 2vw + 0.5rem, 2rem)", paddingTop: "5px"}}>Admin Page</h1>
            </Col>
        ...
        <PeopleCard people={props.people} updatePople={props.updatePople} deletePeople={props.deletePeople}/>

        <h3 className="mt-3 text-center">Case Studies</h3>
        <CasesCard cases={props.cases} updateCase={props.updateCase} deleteCase={props.deleteCase}/>
